#
#  Be sure to run `pod spec lint PullToBounce.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/entotsu/PullToBounce.git", :tag => s.version }
  ...
  s.source_files  = "Classes", "PullToBounce/Source/**/*.{swift}"
